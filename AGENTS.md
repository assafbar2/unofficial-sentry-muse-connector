...
- Repeat the unofficial disclaimer on every new user-facing string, API envelope, and doc heading.
...
- Questions: Assaf Barnir <barnir@agentmail.to> (personal contact for this unofficial sketch).
